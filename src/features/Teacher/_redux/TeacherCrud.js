...
const ADD_EDIT_TEACHER_URL = "/api/v3/content?cmd=edit&type=UserEnt";
const ADD_MUCH_TEACHER_URL = "/api/v3/content4?cmd=AddUsers";
...
const addMuchTeacher = (data) => {
    return axiosClient.post(ADD_MUCH_TEACHER_URL, JSON.stringify(data));
};
